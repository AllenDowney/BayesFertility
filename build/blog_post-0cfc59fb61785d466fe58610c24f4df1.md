...
Response: Underreporting in CPS fertility supplements is a known issue, but it is relatively stable over time. The model is validated against completed cohort fertility rates from Census cohort tables, which mitigates concerns about level bias. The projections rely primarily on relative differences across cohorts rather than absolute birth counts.
